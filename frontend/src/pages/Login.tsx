...
import { authService, getNameFromAccessToken } from "../services/auth.service";
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (token) {
      login(getNameFromAccessToken(token), token);
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-violet-600 hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 transition-colors"
          >
